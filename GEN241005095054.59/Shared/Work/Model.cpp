...
void GetInitialOmega5(double* _omat){
	...
	_omat[0+0+0*1] = 0.1000000000000000056;
}
...
void GradientDeriv(long* _pN, double* _pt, double zzY[], double zzR[], double zzIRate[])
{
	...
	//[0,1] 0.0
	//[1,1]  -(((((tvKm + (A1 / tvV)) * ((tvVmax * exp(nVmax)) / tvV)) - (((tvVmax * exp(nVmax)) * (A1 / tvV)) / tvV)) / ((tvKm + (A1 / tvV)) * (tvKm + (A1 / tvV)))))  is not constant
	//[3,1] ((_A1_nVmax *  -((((((tvKm + (A1 / tvV)) * (tvKm + (A1 / tvV))) * ((((tvVmax * exp(nVmax)) / tvV) / tvV) - ((tvV * ((tvVmax * exp(nVmax)) / tvV)) / (tvV * tvV)))) - ((((tvKm + (A1 / tvV)) * ((tvVmax * exp(nVmax)) / tvV)) - (((tvVmax * exp(nVmax)) * (A1 / tvV)) / tvV)) * (((tvKm + (A1 / tvV)) / tvV) + ((tvKm + (A1 / tvV)) / tvV)))) / (((tvKm + (A1 / tvV)) * (tvKm + (A1 / tvV))) * ((tvKm + (A1 / tvV)) * (tvKm + (A1 / tvV))))))) +  -((((((tvKm + (A1 / tvV)) * (tvKm + (A1 / tvV))) * ((((A1 / tvV) * (tvVmax * exp(nVmax))) / tvV) + ((tvKm + (A1 / tvV)) * ((tvVmax * exp(nVmax)) / tvV)))) - (((tvKm + (A1 / tvV)) * ((A1 / tvV) * (tvVmax * exp(nVmax)))) * (((tvKm + (A1 / tvV)) / tvV) + ((tvKm + (A1 / tvV)) / tvV)))) / (((tvKm + (A1 / tvV)) * (tvKm + (A1 / tvV))) * ((tvKm + (A1 / tvV)) * (tvKm + (A1 / tvV)))))))  is not constant

	//[0,3] 0.0
	//[1,3] 0.0
	//[3,3]  -(((((tvKm + (A1 / tvV)) * ((tvVmax * exp(nVmax)) / tvV)) - (((tvVmax * exp(nVmax)) * (A1 / tvV)) / tvV)) / ((tvKm + (A1 / tvV)) * (tvKm + (A1 / tvV)))))  is not constant
...
void GradientJacobian(int* pN, double* pt, double zzY[], double zzIRate[], int* pML, int* pMU, double* _gjacobian, int* pNRJ){
	...
	_gjacobian[1 + _nrj*0] = tvKa;
		// w.r.t. A1
	_gjacobian[1 + _nrj*1] =  -(((((tvKm + (A1 / tvV)) * ((tvVmax * __temp[0]) / tvV)) - (((tvVmax * __temp[0]) * (A1 / tvV)) / tvV)) / ((tvKm + (A1 / tvV)) * (tvKm + (A1 / tvV)))));
		// forcing rate for A1
	_gjacobian[1 + _nrj*2] = 0.0 + zzIRate[1];
	// rate terms for zzR[2]
	// rate terms for _A1_nVmax
		// w.r.t. A1
	_gjacobian[3 + _nrj*1] = ((_A1_nVmax *  -((((((tvKm + (A1 / tvV)) * (tvKm + (A1 / tvV))) * ((((tvVmax * __temp[0]) / tvV) / tvV) - ((tvV * ((tvVmax * __temp[0]) / tvV)) / (tvV * tvV)))) - ((((tvKm + (A1 / tvV)) * ((tvVmax * __temp[0]) / tvV)) - (((tvVmax * __temp[0]) * (A1 / tvV)) / tvV)) * (((tvKm + (A1 / tvV)) / tvV) + ((tvKm + (A1 / tvV)) / tvV)))) / (((tvKm + (A1 / tvV)) * (tvKm + (A1 / tvV))) * ((tvKm + (A1 / tvV)) * (tvKm + (A1 / tvV))))))) +  -((((((tvKm + (A1 / tvV)) * (tvKm + (A1 / tvV))) * ((((A1 / tvV) * (tvVmax * __temp[0])) / tvV) + ((tvKm + (A1 / tvV)) * ((tvVmax * __temp[0]) / tvV)))) - (((tvKm + (A1 / tvV)) * ((A1 / tvV) * (tvVmax * __temp[0]))) * (((tvKm + (A1 / tvV)) / tvV) + ((tvKm + (A1 / tvV)) / tvV)))) / (((tvKm + (A1 / tvV)) * (tvKm + (A1 / tvV))) * ((tvKm + (A1 / tvV)) * (tvKm + (A1 / tvV)))))));
		// w.r.t. _A1_nVmax
	_gjacobian[3 + _nrj*3] =  -(((((tvKm + (A1 / tvV)) * ((tvVmax * __temp[0]) / tvV)) - (((tvVmax * __temp[0]) * (A1 / tvV)) / tvV)) / ((tvKm + (A1 / tvV)) * (tvKm + (A1 / tvV)))));
}
