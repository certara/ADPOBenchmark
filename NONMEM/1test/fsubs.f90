      ...
      REAL(KIND=DPSIZE), POINTER ::A000034,D000001,D000002,D000035
      REAL(KIND=DPSIZE), POINTER ::D000036,C000033,C000032,D000037
      REAL(KIND=DPSIZE), POINTER ::A000035,A000036,E000007,F000085
      REAL(KIND=DPSIZE), POINTER ::E000010,E000012,F000091,F000088
      REAL(KIND=DPSIZE), POINTER ::F000092,F000089
      CONTAINS
      ...
      D000001=>COM(000016);D000002=>COM(000017);D000035=>COM(000018)
      D000036=>COM(000019);C000033=>COM(000020);C000032=>COM(000021)
      D000037=>COM(000022);A000035=>COM(000023);A000036=>COM(000024)
      E000007=>COM(000025);F000085=>COM(000026);E000010=>COM(000027)
      E000012=>COM(000028);F000091=>COM(000029);F000088=>COM(000030)
      F000092=>COM(000031);F000089=>COM(000032)
...
!                      A000035 = DERIVATIVE OF P000004 W.R.T. ETA(001)
      A000035=A000032 
      GG(0001,1,1)=P000001
      GG(0002,1,1)=P000002
      GG(0003,1,1)=P000003
      GG(0004,1,1)=P000004
      GG(0004,0002,1)=A000035
      GG(0005,1,1)=SC
      ELSE
      GG(0001,1,1)=P000001
      GG(0002,1,1)=P000002
...
!                      C000033 = DERIVATIVE OF Y W.R.T. EPS(001)
      C000033=1.D0 
      IF (FIRSTEM == 1) THEN !1
!                      D000035 = DERIVATIVE OF Y W.R.T. ETA(001)
      D000035=B000001*D000001 
!                      D000037 = DERIVATIVE OF C000032 W.R.T. ETA(001)
      D000037=B000001*D000001 
      G(001,1)=D000035
      ENDIF !1
      HH(001,1)=C000033
      HH(002,1)=C000032
      ...
      IF (MSEC == 1) THEN
      D000002=G(001,002)
!                      D000036 = DERIVATIVE OF D000035 W.R.T. ETA(001)
      D000036=B000001*D000002 
      G(001,002)=D000036
      ENDIF
      F=Y
      RETURN
