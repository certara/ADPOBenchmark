...
$DATA      c:/git/adpoBenchmark/data/sim_1_5_1_1.csv IGNORE=@
  ;; data file name must match out file name in the template file for simulations in data folder
  ;;from data\template.txt
  ;; $TABLE ID TIME AMT IOBS EVID WT FILE=c:\git\dual_numbers\data\OUT_1_5_1_1.DAT NOPRINT NOHEADER NOAPPEND
