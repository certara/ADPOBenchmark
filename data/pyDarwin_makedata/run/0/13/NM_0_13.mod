...
$THETA   
  ...
  (0.0001,0.1,10)	 ;; THETA(7) K23
  (0.0001,0.05,10)	 ;; THETA(8) K32 
  ;; Start OMEGA5
$OMEGA  
...
$SIM (2345) ONLYSIM 
$TABLE ID TIME AMT IOBS EVID WT FILE=c:\git\adpoBenchmark\data\OUT_2_0_0_0.DAT NOPRINT NOHEADER NOAPPEND
  ;;; Model Identifier =  2,0,0,0
$TABLE ID VMAX KM V2 KA FIRSTONLY NOAPPEND NOPRINT FILE= c:\git\adpoBenchmark\data\PARMS_2_0_0_0.DAT
