...
$SIM (2345) ONLYSIM 
$TABLE ID TIME AMT IOBS EVID WT FILE=c:\git\adpoBenchmark\data\OUT_2_2_0_0.DAT NOPRINT NOHEADER NOAPPEND
  ;;; Model Identifier =  2,2,0,0
$TABLE ID VMAX KM V2 KA FIRSTONLY NOAPPEND NOPRINT FILE= c:\git\adpoBenchmark\data\PARMS_2_2_0_0.DAT
