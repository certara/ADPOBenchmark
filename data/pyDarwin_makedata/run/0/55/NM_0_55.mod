...
$SIM (2345) ONLYSIM 
$TABLE ID TIME AMT IOBS EVID WT FILE=c:\git\adpoBenchmark\data\OUT_0_0_1_1.DAT NOPRINT NOHEADER NOAPPEND
  ;;; Model Identifier =  0,0,1,1
$TABLE ID VMAX KM V2 KA FIRSTONLY NOAPPEND NOPRINT FILE= c:\git\adpoBenchmark\data\PARMS_0_0_1_1.DAT
