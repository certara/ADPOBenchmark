...
$SIM (2345) ONLYSIM 
$TABLE ID TIME AMT IOBS EVID WT FILE=c:\git\adpoBenchmark\data\OUT_2_4_0_1.DAT NOPRINT NOHEADER NOAPPEND
  ;;; Model Identifier =  2,4,0,1
$TABLE ID VMAX KM V2 KA FIRSTONLY NOAPPEND NOPRINT FILE= c:\git\adpoBenchmark\data\PARMS_2_4_0_1.DAT

;; Phenotype: ([('COMP', 2), ('ETAs', 4), ('V~WT', 0), ('GAMMA', 1)])
;; Genotype: [2, 4, 0, 1]
