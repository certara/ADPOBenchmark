...
$SIM (2345) ONLYSIM 
$TABLE ID TIME AMT IOBS EVID WT FILE=c:\git\adpoBenchmark\data\OUT_0_2_1_0.DAT NOPRINT NOHEADER NOAPPEND
  ;;; Model Identifier =  0,2,1,0
$TABLE ID VMAX KM V2 KA FIRSTONLY NOAPPEND NOPRINT FILE= c:\git\adpoBenchmark\data\PARMS_0_2_1_0.DAT
