...
$SIM (2345) ONLYSIM 
$TABLE ID TIME AMT IOBS EVID WT FILE=c:\git\adpoBenchmark\data\OUT_1_5_1_1.DAT NOPRINT NOHEADER NOAPPEND
  ;;; Model Identifier =  1,5,1,1
$TABLE ID VMAX KM V2 KA FIRSTONLY NOAPPEND NOPRINT FILE= c:\git\adpoBenchmark\data\PARMS_1_5_1_1.DAT

;; Phenotype: ([('COMP', 1), ('ETAs', 5), ('V~WT', 1), ('GAMMA', 1)])
;; Genotype: [1, 5, 1, 1]
