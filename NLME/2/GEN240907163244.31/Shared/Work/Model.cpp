...
void Deriv(long* _pN, double* _pt, double zzY[], double zzR[], double zzIRate[]){
	...
	// tvKa
	// 0.0
	//  -(((((tvKm + (A1 / (tvV * exp(nV)))) * ((tvVmax * exp(nVmax)) / (tvV * exp(nV)))) - (((tvVmax * exp(nVmax)) * (A1 / (tvV * exp(nV)))) / (tvV * exp(nV)))) / ((tvKm + (A1 / (tvV * exp(nV)))) * (tvKm + (A1 / (tvV * exp(nV)))))))  is not constant
	// 0.0
	// 0.0
void Jacobian(int* pN, double* pt, double zzY[], double zzIRate[], int* pML, int* pMU, double* _jacobian, int* pNRJ){
	...
	_jacobian[1 + _nrj*0] = tvKa;
		// w.r.t. A1
	_jacobian[1 + _nrj*1] =  -(((((tvKm + (A1 / (tvV * __temp[0]))) * ((tvVmax * __temp[1]) / (tvV * __temp[0]))) - (((tvVmax * __temp[1]) * (A1 / (tvV * __temp[0]))) / (tvV * __temp[0]))) / ((tvKm + (A1 / (tvV * __temp[0]))) * (tvKm + (A1 / (tvV * __temp[0]))))));
		// forcing rate for A1
...
#define     _A1_nV       zzY1[1]
#define zzR__A1_nV       zzR1[1]

#define NINTEG_GRADIENT_DERIV 2
...
void GradientDeriv(long* _pN, double* _pt, double zzY[], double zzR[], double zzIRate[])
{
	...
	zzR__A1_nV = (((Ka * _Aa_nV) + ( -(((((Km + (A1 / V)) * (Vmax / V)) - ((Vmax * (A1 / V)) / V)) / ((Km + (A1 / V)) * (Km + (A1 / V))))) * _A1_nV)) +  -(((((Km + (A1 / V)) * (Vmax * ( -((A1 * V)) / (V * V)))) - ((Vmax * (A1 / V)) * ( -((A1 * V)) / (V * V)))) / ((Km + (A1 / V)) * (Km + (A1 / V))))));
}
	//[0,0]  -(tvKa)
	//[1,0] tvKa
	//[3,0] 0.0
	...
	//[0,1] 0.0
	//[1,1]  -(((((tvKm + (A1 / (tvV * exp(nV)))) * ((tvVmax * exp(nVmax)) / (tvV * exp(nV)))) - (((tvVmax * exp(nVmax)) * (A1 / (tvV * exp(nV)))) / (tvV * exp(nV)))) / ((tvKm + (A1 / (tvV * exp(nV)))) * (tvKm + (A1 / (tvV * exp(nV)))))))  is not constant
	...
	//[4,1] ((_A1_nV *  -((((((tvKm + (A1 / (tvV * exp(nV)))) * (tvKm + (A1 / (tvV * exp(nV))))) * ((((tvVmax * exp(nVmax)) / (tvV * exp(nV))) / (tvV * exp(nV))) - (((tvV * exp(nV)) * ((tvVmax * exp(nVmax)) / (tvV * exp(nV)))) / ((tvV * exp(nV)) * (tvV * exp(nV)))))) - ((((tvKm + (A1 / (tvV * exp(nV)))) * ((tvVmax * exp(nVmax)) / (tvV * exp(nV)))) - (((tvVmax * exp(nVmax)) * (A1 / (tvV * exp(nV)))) / (tvV * exp(nV)))) * (((tvKm + (A1 / (tvV * exp(nV)))) / (tvV * exp(nV))) + ((tvKm + (A1 / (tvV * exp(nV)))) / (tvV * exp(nV)))))) / (((tvKm + (A1 / (tvV * exp(nV)))) * (tvKm + (A1 / (tvV * exp(nV))))) * ((tvKm + (A1 / (tvV * exp(nV)))) * (tvKm + (A1 / (tvV * exp(nV))))))))) +  -((((((tvKm + (A1 / (tvV * exp(nV)))) * (tvKm + (A1 / (tvV * exp(nV))))) * (((((tvVmax * exp(nVmax)) * ( -((A1 * (tvV * exp(nV)))) / ((tvV * exp(nV)) * (tvV * exp(nV))))) / (tvV * exp(nV))) + ((tvKm + (A1 / (tvV * exp(nV)))) * ((tvVmax * exp(nVmax)) * ((((tvV * exp(nV)) * (tvV * exp(nV))) *  -((tvV * exp(nV)))) / (((tvV * exp(nV)) * (tvV * exp(nV))) * ((tvV * exp(nV)) * (tvV * exp(nV)))))))) - ((( -((A1 * (tvV * exp(nV)))) / ((tvV * exp(nV)) * (tvV * exp(nV)))) * ((tvVmax * exp(nVmax)) / (tvV * exp(nV)))) + (((tvVmax * exp(nVmax)) * (A1 / (tvV * exp(nV)))) * ((((tvV * exp(nV)) * (tvV * exp(nV))) *  -((tvV * exp(nV)))) / (((tvV * exp(nV)) * (tvV * exp(nV))) * ((tvV * exp(nV)) * (tvV * exp(nV))))))))) - ((((tvKm + (A1 / (tvV * exp(nV)))) * ((tvVmax * exp(nVmax)) * ( -((A1 * (tvV * exp(nV)))) / ((tvV * exp(nV)) * (tvV * exp(nV)))))) - (((tvVmax * exp(nVmax)) * (A1 / (tvV * exp(nV)))) * ( -((A1 * (tvV * exp(nV)))) / ((tvV * exp(nV)) * (tvV * exp(nV)))))) * (((tvKm + (A1 / (tvV * exp(nV)))) / (tvV * exp(nV))) + ((tvKm + (A1 / (tvV * exp(nV)))) / (tvV * exp(nV)))))) / (((tvKm + (A1 / (tvV * exp(nV)))) * (tvKm + (A1 / (tvV * exp(nV))))) * ((tvKm + (A1 / (tvV * exp(nV)))) * (tvKm + (A1 / (tvV * exp(nV)))))))))  is not constant

	//[0,3] 0.0
	//[1,3] 0.0
	//[3,3]  -(((((tvKm + (A1 / (tvV * exp(nV)))) * ((tvVmax * exp(nVmax)) / (tvV * exp(nV)))) - (((tvVmax * exp(nVmax)) * (A1 / (tvV * exp(nV)))) / (tvV * exp(nV)))) / ((tvKm + (A1 / (tvV * exp(nV)))) * (tvKm + (A1 / (tvV * exp(nV)))))))  is not constant
	//[4,3] 0.0

	//[0,4] 0.0
	//[1,4] 0.0
	//[3,4] 0.0
	//[4,4]  -(((((tvKm + (A1 / (tvV * exp(nV)))) * ((tvVmax * exp(nVmax)) / (tvV * exp(nV)))) - (((tvVmax * exp(nVmax)) * (A1 / (tvV * exp(nV)))) / (tvV * exp(nV)))) / ((tvKm + (A1 / (tvV * exp(nV)))) * (tvKm + (A1 / (tvV * exp(nV)))))))  is not constant
...
void GradientJacobian(int* pN, double* pt, double zzY[], double zzIRate[], int* pML, int* pMU, double* _gjacobian, int* pNRJ){
	...
	_gjacobian[1 + _nrj*0] = tvKa;
		// w.r.t. A1
	_gjacobian[1 + _nrj*1] =  -(((((tvKm + (A1 / (tvV * __temp[0]))) * ((tvVmax * __temp[1]) / (tvV * __temp[0]))) - (((tvVmax * __temp[1]) * (A1 / (tvV * __temp[0]))) / (tvV * __temp[0]))) / ((tvKm + (A1 / (tvV * __temp[0]))) * (tvKm + (A1 / (tvV * __temp[0]))))));
		// forcing rate for A1
	...
	_gjacobian[3 + _nrj*1] = ((_A1_nVmax *  -((((((tvKm + (A1 / (tvV * __temp[0]))) * (tvKm + (A1 / (tvV * __temp[0])))) * ((((tvVmax * __temp[1]) / (tvV * __temp[0])) / (tvV * __temp[0])) - (((tvV * __temp[0]) * ((tvVmax * __temp[1]) / (tvV * __temp[0]))) / ((tvV * __temp[0]) * (tvV * __temp[0]))))) - ((((tvKm + (A1 / (tvV * __temp[0]))) * ((tvVmax * __temp[1]) / (tvV * __temp[0]))) - (((tvVmax * __temp[1]) * (A1 / (tvV * __temp[0]))) / (tvV * __temp[0]))) * (((tvKm + (A1 / (tvV * __temp[0]))) / (tvV * __temp[0])) + ((tvKm + (A1 / (tvV * __temp[0]))) / (tvV * __temp[0]))))) / (((tvKm + (A1 / (tvV * __temp[0]))) * (tvKm + (A1 / (tvV * __temp[0])))) * ((tvKm + (A1 / (tvV * __temp[0]))) * (tvKm + (A1 / (tvV * __temp[0])))))))) +  -((((((tvKm + (A1 / (tvV * __temp[0]))) * (tvKm + (A1 / (tvV * __temp[0])))) * ((((A1 / (tvV * __temp[0])) * (tvVmax * __temp[1])) / (tvV * __temp[0])) + ((tvKm + (A1 / (tvV * __temp[0]))) * ((tvVmax * __temp[1]) / (tvV * __temp[0]))))) - (((tvKm + (A1 / (tvV * __temp[0]))) * ((A1 / (tvV * __temp[0])) * (tvVmax * __temp[1]))) * (((tvKm + (A1 / (tvV * __temp[0]))) / (tvV * __temp[0])) + ((tvKm + (A1 / (tvV * __temp[0]))) / (tvV * __temp[0]))))) / (((tvKm + (A1 / (tvV * __temp[0]))) * (tvKm + (A1 / (tvV * __temp[0])))) * ((tvKm + (A1 / (tvV * __temp[0]))) * (tvKm + (A1 / (tvV * __temp[0]))))))));
		// w.r.t. _A1_nVmax
	_gjacobian[3 + _nrj*3] =  -(((((tvKm + (A1 / (tvV * __temp[0]))) * ((tvVmax * __temp[1]) / (tvV * __temp[0]))) - (((tvVmax * __temp[1]) * (A1 / (tvV * __temp[0]))) / (tvV * __temp[0]))) / ((tvKm + (A1 / (tvV * __temp[0]))) * (tvKm + (A1 / (tvV * __temp[0]))))));
	// rate terms for _A1_nV
		// w.r.t. A1
	_gjacobian[4 + _nrj*1] = ((_A1_nV *  -((((((tvKm + (A1 / (tvV * __temp[0]))) * (tvKm + (A1 / (tvV * __temp[0])))) * ((((tvVmax * __temp[1]) / (tvV * __temp[0])) / (tvV * __temp[0])) - (((tvV * __temp[0]) * ((tvVmax * __temp[1]) / (tvV * __temp[0]))) / ((tvV * __temp[0]) * (tvV * __temp[0]))))) - ((((tvKm + (A1 / (tvV * __temp[0]))) * ((tvVmax * __temp[1]) / (tvV * __temp[0]))) - (((tvVmax * __temp[1]) * (A1 / (tvV * __temp[0]))) / (tvV * __temp[0]))) * (((tvKm + (A1 / (tvV * __temp[0]))) / (tvV * __temp[0])) + ((tvKm + (A1 / (tvV * __temp[0]))) / (tvV * __temp[0]))))) / (((tvKm + (A1 / (tvV * __temp[0]))) * (tvKm + (A1 / (tvV * __temp[0])))) * ((tvKm + (A1 / (tvV * __temp[0]))) * (tvKm + (A1 / (tvV * __temp[0])))))))) +  -((((((tvKm + (A1 / (tvV * __temp[0]))) * (tvKm + (A1 / (tvV * __temp[0])))) * (((((tvVmax * __temp[1]) * ( -((A1 * (tvV * __temp[0]))) / ((tvV * __temp[0]) * (tvV * __temp[0])))) / (tvV * __temp[0])) + ((tvKm + (A1 / (tvV * __temp[0]))) * ((tvVmax * __temp[1]) * ((((tvV * __temp[0]) * (tvV * __temp[0])) *  -((tvV * __temp[0]))) / (((tvV * __temp[0]) * (tvV * __temp[0])) * ((tvV * __temp[0]) * (tvV * __temp[0]))))))) - ((( -((A1 * (tvV * __temp[0]))) / ((tvV * __temp[0]) * (tvV * __temp[0]))) * ((tvVmax * __temp[1]) / (tvV * __temp[0]))) + (((tvVmax * __temp[1]) * (A1 / (tvV * __temp[0]))) * ((((tvV * __temp[0]) * (tvV * __temp[0])) *  -((tvV * __temp[0]))) / (((tvV * __temp[0]) * (tvV * __temp[0])) * ((tvV * __temp[0]) * (tvV * __temp[0])))))))) - ((((tvKm + (A1 / (tvV * __temp[0]))) * ((tvVmax * __temp[1]) * ( -((A1 * (tvV * __temp[0]))) / ((tvV * __temp[0]) * (tvV * __temp[0]))))) - (((tvVmax * __temp[1]) * (A1 / (tvV * __temp[0]))) * ( -((A1 * (tvV * __temp[0]))) / ((tvV * __temp[0]) * (tvV * __temp[0]))))) * (((tvKm + (A1 / (tvV * __temp[0]))) / (tvV * __temp[0])) + ((tvKm + (A1 / (tvV * __temp[0]))) / (tvV * __temp[0]))))) / (((tvKm + (A1 / (tvV * __temp[0]))) * (tvKm + (A1 / (tvV * __temp[0])))) * ((tvKm + (A1 / (tvV * __temp[0]))) * (tvKm + (A1 / (tvV * __temp[0]))))))));
		// w.r.t. _A1_nV
	_gjacobian[4 + _nrj*4] =  -(((((tvKm + (A1 / (tvV * __temp[0]))) * ((tvVmax * __temp[1]) / (tvV * __temp[0]))) - (((tvVmax * __temp[1]) * (A1 / (tvV * __temp[0]))) / (tvV * __temp[0]))) / ((tvKm + (A1 / (tvV * __temp[0]))) * (tvKm + (A1 / (tvV * __temp[0]))))));
}
