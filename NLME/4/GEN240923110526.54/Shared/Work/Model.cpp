...
void Jacobian(int* pN, double* pt, double zzY[], double zzIRate[], int* pML, int* pMU, double* _jacobian, int* pNRJ){
	...
	_jacobian[1 + _nrj*0] = (tvKa * __temp[0]);
		// w.r.t. A1
	_jacobian[1 + _nrj*1] =  -((((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvVmax * __temp[3]) / (tvV * __temp[2]))) - (((tvVmax * __temp[3]) * (A1 / (tvV * __temp[2]))) / (tvV * __temp[2]))) / (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))))));
		// forcing rate for A1
...
#define     _Aa_nKa       zzY1[3]
#define zzR__Aa_nKa       zzR1[3]

#define     _A1_nKa       zzY1[4]
#define zzR__A1_nKa       zzR1[4]

#define NINTEG_GRADIENT_DERIV 5
...
void GradientDeriv(long* _pN, double* _pt, double zzY[], double zzR[], double zzIRate[])
{
	...
	zzR__A1_nKa = (((Ka * _Aa_nKa) + ( -(((((Km + (A1 / V)) * (Vmax / V)) - ((Vmax * (A1 / V)) / V)) / ((Km + (A1 / V)) * (Km + (A1 / V))))) * _A1_nKa)) + (Aa * Ka));
}
	//[0,0]  -((tvKa * exp(nKa)))
	//[1,0] (tvKa * exp(nKa))
	//[3,0] 0.0
	...
	//[6,1] 0.0
	//[7,1] (_A1_nKa *  -(((((((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) * ((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm))))) * ((((tvVmax * exp(nVmax)) / (tvV * exp(nKm))) / (tvV * exp(nKm))) - (((tvV * exp(nKm)) * ((tvVmax * exp(nVmax)) / (tvV * exp(nKm)))) / ((tvV * exp(nKm)) * (tvV * exp(nKm)))))) - (((((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) * ((tvVmax * exp(nVmax)) / (tvV * exp(nKm)))) - (((tvVmax * exp(nVmax)) * (A1 / (tvV * exp(nKm)))) / (tvV * exp(nKm)))) * ((((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) / (tvV * exp(nKm))) + (((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) / (tvV * exp(nKm)))))) / ((((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) * ((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm))))) * (((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) * ((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))))))))  is not constant
	...
	//[5,7] 0.0
	//[6,7] 0.0
	//[7,7]  -((((((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) * ((tvVmax * exp(nVmax)) / (tvV * exp(nKm)))) - (((tvVmax * exp(nVmax)) * (A1 / (tvV * exp(nKm)))) / (tvV * exp(nKm)))) / (((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) * ((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))))))  is not constant
...
void GradientJacobian(int* pN, double* pt, double zzY[], double zzIRate[], int* pML, int* pMU, double* _gjacobian, int* pNRJ){
	...
	_gjacobian[1 + _nrj*0] = (tvKa * __temp[0]);
		// w.r.t. A1
	_gjacobian[1 + _nrj*1] =  -((((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvVmax * __temp[3]) / (tvV * __temp[2]))) - (((tvVmax * __temp[3]) * (A1 / (tvV * __temp[2]))) / (tvV * __temp[2]))) / (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))))));
		// forcing rate for A1
	...
	_gjacobian[3 + _nrj*1] = ((_A1_nVmax *  -(((((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2])))) * ((((tvVmax * __temp[3]) / (tvV * __temp[2])) / (tvV * __temp[2])) - (((tvV * __temp[2]) * ((tvVmax * __temp[3]) / (tvV * __temp[2]))) / ((tvV * __temp[2]) * (tvV * __temp[2]))))) - (((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvVmax * __temp[3]) / (tvV * __temp[2]))) - (((tvVmax * __temp[3]) * (A1 / (tvV * __temp[2]))) / (tvV * __temp[2]))) * ((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) / (tvV * __temp[2])) + (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) / (tvV * __temp[2]))))) / ((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2])))) * (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2])))))))) +  -(((((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2])))) * ((((A1 / (tvV * __temp[2])) * (tvVmax * __temp[3])) / (tvV * __temp[2])) + (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvVmax * __temp[3]) / (tvV * __temp[2]))))) - ((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((A1 / (tvV * __temp[2])) * (tvVmax * __temp[3]))) * ((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) / (tvV * __temp[2])) + (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) / (tvV * __temp[2]))))) / ((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2])))) * (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))))))));
		// w.r.t. _A1_nVmax
	_gjacobian[3 + _nrj*3] =  -((((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvVmax * __temp[3]) / (tvV * __temp[2]))) - (((tvVmax * __temp[3]) * (A1 / (tvV * __temp[2]))) / (tvV * __temp[2]))) / (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))))));
	// rate terms for _A1_nKm
		// w.r.t. A1
	_gjacobian[4 + _nrj*1] = ((_A1_nKm *  -(((((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2])))) * ((((tvVmax * __temp[3]) / (tvV * __temp[2])) / (tvV * __temp[2])) - (((tvV * __temp[2]) * ((tvVmax * __temp[3]) / (tvV * __temp[2]))) / ((tvV * __temp[2]) * (tvV * __temp[2]))))) - (((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvVmax * __temp[3]) / (tvV * __temp[2]))) - (((tvVmax * __temp[3]) * (A1 / (tvV * __temp[2]))) / (tvV * __temp[2]))) * ((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) / (tvV * __temp[2])) + (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) / (tvV * __temp[2]))))) / ((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2])))) * (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2])))))))) +  -(((((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2])))) * (((((tvVmax * __temp[3]) * ( -((A1 * (tvV * __temp[2]))) / ((tvV * __temp[2]) * (tvV * __temp[2])))) / (tvV * __temp[2])) + (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvVmax * __temp[3]) * ((((tvV * __temp[2]) * (tvV * __temp[2])) *  -((tvV * __temp[2]))) / (((tvV * __temp[2]) * (tvV * __temp[2])) * ((tvV * __temp[2]) * (tvV * __temp[2]))))))) - ((( -((A1 * (tvV * __temp[2]))) / ((tvV * __temp[2]) * (tvV * __temp[2]))) * ((tvVmax * __temp[3]) / (tvV * __temp[2]))) + (((tvVmax * __temp[3]) * (A1 / (tvV * __temp[2]))) * ((((tvV * __temp[2]) * (tvV * __temp[2])) *  -((tvV * __temp[2]))) / (((tvV * __temp[2]) * (tvV * __temp[2])) * ((tvV * __temp[2]) * (tvV * __temp[2])))))))) - (((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvVmax * __temp[3]) * ( -((A1 * (tvV * __temp[2]))) / ((tvV * __temp[2]) * (tvV * __temp[2]))))) - (((tvVmax * __temp[3]) * (A1 / (tvV * __temp[2]))) * ( -((A1 * (tvV * __temp[2]))) / ((tvV * __temp[2]) * (tvV * __temp[2]))))) * ((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) / (tvV * __temp[2])) + (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) / (tvV * __temp[2]))))) / ((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2])))) * (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))))))));
		// w.r.t. _A1_nKm
	_gjacobian[4 + _nrj*4] =  -((((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvVmax * __temp[3]) / (tvV * __temp[2]))) - (((tvVmax * __temp[3]) * (A1 / (tvV * __temp[2]))) / (tvV * __temp[2]))) / (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))))));
	// rate terms for _A1_nV
		// w.r.t. A1
	_gjacobian[5 + _nrj*1] = ((_A1_nV *  -(((((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2])))) * ((((tvVmax * __temp[3]) / (tvV * __temp[2])) / (tvV * __temp[2])) - (((tvV * __temp[2]) * ((tvVmax * __temp[3]) / (tvV * __temp[2]))) / ((tvV * __temp[2]) * (tvV * __temp[2]))))) - (((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvVmax * __temp[3]) / (tvV * __temp[2]))) - (((tvVmax * __temp[3]) * (A1 / (tvV * __temp[2]))) / (tvV * __temp[2]))) * ((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) / (tvV * __temp[2])) + (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) / (tvV * __temp[2]))))) / ((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2])))) * (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2])))))))) +  -(((((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2])))) *  -(((tvKm * __temp[1]) * ((tvVmax * __temp[3]) / (tvV * __temp[2]))))) - ( -((((tvVmax * __temp[3]) * (A1 / (tvV * __temp[2]))) * (tvKm * __temp[1]))) * ((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) / (tvV * __temp[2])) + (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) / (tvV * __temp[2]))))) / ((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2])))) * (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))))))));
		// w.r.t. _A1_nV
	_gjacobian[5 + _nrj*5] =  -((((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvVmax * __temp[3]) / (tvV * __temp[2]))) - (((tvVmax * __temp[3]) * (A1 / (tvV * __temp[2]))) / (tvV * __temp[2]))) / (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))))));
	// rate terms for _Aa_nKa
		// w.r.t. Aa
	_gjacobian[6 + _nrj*0] =  -((tvKa * __temp[0]));
		// w.r.t. _Aa_nKa
	_gjacobian[6 + _nrj*6] =  -((tvKa * __temp[0]));
	// rate terms for _A1_nKa
		// w.r.t. Aa
	_gjacobian[7 + _nrj*0] = (tvKa * __temp[0]);
		// w.r.t. A1
	_gjacobian[7 + _nrj*1] = (_A1_nKa *  -(((((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2])))) * ((((tvVmax * __temp[3]) / (tvV * __temp[2])) / (tvV * __temp[2])) - (((tvV * __temp[2]) * ((tvVmax * __temp[3]) / (tvV * __temp[2]))) / ((tvV * __temp[2]) * (tvV * __temp[2]))))) - (((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvVmax * __temp[3]) / (tvV * __temp[2]))) - (((tvVmax * __temp[3]) * (A1 / (tvV * __temp[2]))) / (tvV * __temp[2]))) * ((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) / (tvV * __temp[2])) + (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) / (tvV * __temp[2]))))) / ((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2])))) * (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))))))));
		// w.r.t. _Aa_nKa
	_gjacobian[7 + _nrj*6] = (tvKa * __temp[0]);
		// w.r.t. _A1_nKa
	_gjacobian[7 + _nrj*7] =  -((((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvVmax * __temp[3]) / (tvV * __temp[2]))) - (((tvVmax * __temp[3]) * (A1 / (tvV * __temp[2]))) / (tvV * __temp[2]))) / (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))))));
}
