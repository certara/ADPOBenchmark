...
void GetInitialOmega5(double* _omat){
	...
	_omat[0+0+0*3] = 0.3099999999999999978;
	_omat[0+1+1*3] = 0.3099999999999999978;
	_omat[0+2+2*3] = 0.3099999999999999978;
}
...
void Jacobian(int* pN, double* pt, double zzY[], double zzIRate[], int* pML, int* pMU, double* _jacobian, int* pNRJ){
	...
	_jacobian[1 + _nrj*0] = tvKa;
		// w.r.t. A1
	_jacobian[1 + _nrj*1] = ( -(K12) - (((((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) * ((tvVmax * __temp[2]) / (tvV * __temp[1]))) - (((tvVmax * __temp[2]) * (A1 / (tvV * __temp[1]))) / (tvV * __temp[1]))) / (((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) * ((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))))));
		// w.r.t. A2
...
void GradientJacobian(int* pN, double* pt, double zzY[], double zzIRate[], int* pML, int* pMU, double* _gjacobian, int* pNRJ){
	...
	_gjacobian[1 + _nrj*0] = tvKa;
		// w.r.t. A1
	_gjacobian[1 + _nrj*1] = ( -(K12) - (((((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) * ((tvVmax * __temp[2]) / (tvV * __temp[1]))) - (((tvVmax * __temp[2]) * (A1 / (tvV * __temp[1]))) / (tvV * __temp[1]))) / (((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) * ((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))))));
		// w.r.t. A2
	...
	_gjacobian[4 + _nrj*1] = ((_A1_nVmax *  -(((((((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) * ((tvKm * __temp[0]) + (A1 / (tvV * __temp[1])))) * ((((tvVmax * __temp[2]) / (tvV * __temp[1])) / (tvV * __temp[1])) - (((tvV * __temp[1]) * ((tvVmax * __temp[2]) / (tvV * __temp[1]))) / ((tvV * __temp[1]) * (tvV * __temp[1]))))) - (((((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) * ((tvVmax * __temp[2]) / (tvV * __temp[1]))) - (((tvVmax * __temp[2]) * (A1 / (tvV * __temp[1]))) / (tvV * __temp[1]))) * ((((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) / (tvV * __temp[1])) + (((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) / (tvV * __temp[1]))))) / ((((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) * ((tvKm * __temp[0]) + (A1 / (tvV * __temp[1])))) * (((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) * ((tvKm * __temp[0]) + (A1 / (tvV * __temp[1])))))))) +  -(((((((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) * ((tvKm * __temp[0]) + (A1 / (tvV * __temp[1])))) * ((((A1 / (tvV * __temp[1])) * (tvVmax * __temp[2])) / (tvV * __temp[1])) + (((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) * ((tvVmax * __temp[2]) / (tvV * __temp[1]))))) - ((((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) * ((A1 / (tvV * __temp[1])) * (tvVmax * __temp[2]))) * ((((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) / (tvV * __temp[1])) + (((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) / (tvV * __temp[1]))))) / ((((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) * ((tvKm * __temp[0]) + (A1 / (tvV * __temp[1])))) * (((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) * ((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))))))));
		// w.r.t. _A1_nVmax
	_gjacobian[4 + _nrj*4] = ( -(K12) - (((((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) * ((tvVmax * __temp[2]) / (tvV * __temp[1]))) - (((tvVmax * __temp[2]) * (A1 / (tvV * __temp[1]))) / (tvV * __temp[1]))) / (((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) * ((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))))));
		// w.r.t. _A2_nVmax
	...
	// rate terms for _A1_nKm
		// w.r.t. A1
	_gjacobian[6 + _nrj*1] = ((_A1_nKm *  -(((((((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) * ((tvKm * __temp[0]) + (A1 / (tvV * __temp[1])))) * ((((tvVmax * __temp[2]) / (tvV * __temp[1])) / (tvV * __temp[1])) - (((tvV * __temp[1]) * ((tvVmax * __temp[2]) / (tvV * __temp[1]))) / ((tvV * __temp[1]) * (tvV * __temp[1]))))) - (((((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) * ((tvVmax * __temp[2]) / (tvV * __temp[1]))) - (((tvVmax * __temp[2]) * (A1 / (tvV * __temp[1]))) / (tvV * __temp[1]))) * ((((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) / (tvV * __temp[1])) + (((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) / (tvV * __temp[1]))))) / ((((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) * ((tvKm * __temp[0]) + (A1 / (tvV * __temp[1])))) * (((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) * ((tvKm * __temp[0]) + (A1 / (tvV * __temp[1])))))))) +  -(((((((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) * ((tvKm * __temp[0]) + (A1 / (tvV * __temp[1])))) * (((((tvVmax * __temp[2]) * ( -((A1 * (tvV * __temp[1]))) / ((tvV * __temp[1]) * (tvV * __temp[1])))) / (tvV * __temp[1])) + (((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) * ((tvVmax * __temp[2]) * ((((tvV * __temp[1]) * (tvV * __temp[1])) *  -((tvV * __temp[1]))) / (((tvV * __temp[1]) * (tvV * __temp[1])) * ((tvV * __temp[1]) * (tvV * __temp[1]))))))) - ((( -((A1 * (tvV * __temp[1]))) / ((tvV * __temp[1]) * (tvV * __temp[1]))) * ((tvVmax * __temp[2]) / (tvV * __temp[1]))) + (((tvVmax * __temp[2]) * (A1 / (tvV * __temp[1]))) * ((((tvV * __temp[1]) * (tvV * __temp[1])) *  -((tvV * __temp[1]))) / (((tvV * __temp[1]) * (tvV * __temp[1])) * ((tvV * __temp[1]) * (tvV * __temp[1])))))))) - (((((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) * ((tvVmax * __temp[2]) * ( -((A1 * (tvV * __temp[1]))) / ((tvV * __temp[1]) * (tvV * __temp[1]))))) - (((tvVmax * __temp[2]) * (A1 / (tvV * __temp[1]))) * ( -((A1 * (tvV * __temp[1]))) / ((tvV * __temp[1]) * (tvV * __temp[1]))))) * ((((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) / (tvV * __temp[1])) + (((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) / (tvV * __temp[1]))))) / ((((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) * ((tvKm * __temp[0]) + (A1 / (tvV * __temp[1])))) * (((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) * ((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))))))));
		// w.r.t. _A1_nKm
	_gjacobian[6 + _nrj*6] = ( -(K12) - (((((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) * ((tvVmax * __temp[2]) / (tvV * __temp[1]))) - (((tvVmax * __temp[2]) * (A1 / (tvV * __temp[1]))) / (tvV * __temp[1]))) / (((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) * ((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))))));
		// w.r.t. _A2_nKm
	...
	// rate terms for _A1_nV
		// w.r.t. A1
	_gjacobian[8 + _nrj*1] = ((_A1_nV *  -(((((((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) * ((tvKm * __temp[0]) + (A1 / (tvV * __temp[1])))) * ((((tvVmax * __temp[2]) / (tvV * __temp[1])) / (tvV * __temp[1])) - (((tvV * __temp[1]) * ((tvVmax * __temp[2]) / (tvV * __temp[1]))) / ((tvV * __temp[1]) * (tvV * __temp[1]))))) - (((((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) * ((tvVmax * __temp[2]) / (tvV * __temp[1]))) - (((tvVmax * __temp[2]) * (A1 / (tvV * __temp[1]))) / (tvV * __temp[1]))) * ((((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) / (tvV * __temp[1])) + (((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) / (tvV * __temp[1]))))) / ((((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) * ((tvKm * __temp[0]) + (A1 / (tvV * __temp[1])))) * (((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) * ((tvKm * __temp[0]) + (A1 / (tvV * __temp[1])))))))) +  -(((((((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) * ((tvKm * __temp[0]) + (A1 / (tvV * __temp[1])))) *  -(((tvKm * __temp[0]) * ((tvVmax * __temp[2]) / (tvV * __temp[1]))))) - ( -((((tvVmax * __temp[2]) * (A1 / (tvV * __temp[1]))) * (tvKm * __temp[0]))) * ((((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) / (tvV * __temp[1])) + (((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) / (tvV * __temp[1]))))) / ((((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) * ((tvKm * __temp[0]) + (A1 / (tvV * __temp[1])))) * (((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) * ((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))))))));
		// w.r.t. _A1_nV
	_gjacobian[8 + _nrj*8] = ( -(K12) - (((((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) * ((tvVmax * __temp[2]) / (tvV * __temp[1]))) - (((tvVmax * __temp[2]) * (A1 / (tvV * __temp[1]))) / (tvV * __temp[1]))) / (((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))) * ((tvKm * __temp[0]) + (A1 / (tvV * __temp[1]))))));
		// w.r.t. _A2_nV
