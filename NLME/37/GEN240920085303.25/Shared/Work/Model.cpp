...
int GetNThetaOld(){	// get number of theta minus possibly 1 sigma to estimate
	int _n = 6 + 1; // number of fixefs + number of epsilons
...
static double _tempResult[1];
static double _tempArg[1];
int _bTempValid = 0;
void InitTemp(){ int _i;
	for (_i = 0; _i < 1; _i++) _tempResult[_i] = -999999999.0;
	for (_i = 0; _i < 1; _i++) _tempArg[_i]    = -999999999.0;
	_bTempValid = 1;
}
...
void Deriv(long* _pN, double* _pt, double zzY[], double zzR[], double zzIRate[]){
	...
	zzR_Aa = ( -(Ka) * Aa);
	zzR_Aa += _Aa_irate;
	zzR_A1 = ((Ka * Aa) - ((Vmax * pow(C, GAMMA)) / (pow(Km, GAMMA) + pow(C, GAMMA))));
	zzR_A1 += _A1_irate;
	...
	// tvKa
	// 0.0
	//  -(((((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * ((tvVmax * exp(nVmax)) * ((GAMMA * pow((A1 / tvV), (GAMMA - 1.0))) / tvV))) - (((tvVmax * exp(nVmax)) * pow((A1 / tvV), GAMMA)) * ((GAMMA * pow((A1 / tvV), (GAMMA - 1.0))) / tvV))) / ((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * (pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)))))  is not constant
	// 0.0
	// 0.0
void Jacobian(int* pN, double* pt, double zzY[], double zzIRate[], int* pML, int* pMU, double* _jacobian, int* pNRJ){
	...
	_jacobian[1 + _nrj*0] = tvKa;
		// w.r.t. A1
	_jacobian[1 + _nrj*1] =  -(((((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * ((tvVmax * __temp[0]) * ((GAMMA * pow((A1 / tvV), (GAMMA - 1.0))) / tvV))) - (((tvVmax * __temp[0]) * pow((A1 / tvV), GAMMA)) * ((GAMMA * pow((A1 / tvV), (GAMMA - 1.0))) / tvV))) / ((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * (pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)))));
		// forcing rate for A1
...
void GetSaemThetaInfo(int* iaCColToITheta, int* baCColIsLog){
	int _jCTheta = 0;
	int _nTheta = 0;
	int _iaIFixefErrToITheta[6+1];
	int _i;
	for (_i = 0; _i < 6+1; _i++) _iaIFixefErrToITheta[_i] = -1;
...
#define NINTEG_GRADIENT_DERIV 1
...
void GradientDeriv(long* _pN, double* _pt, double zzY[], double zzR[], double zzIRate[])
{
	...
	zzR_A1 += _A1_irate;
	zzR[2] = 0; // extra null equation
	zzR__A1_nVmax = (((Ka * _Aa_nVmax) + ( -(((((pow(Km, GAMMA) + pow((A1 / V), GAMMA)) * (Vmax * ((GAMMA * pow((A1 / V), (GAMMA - 1.0))) / V))) - ((Vmax * pow((A1 / V), GAMMA)) * ((GAMMA * pow((A1 / V), (GAMMA - 1.0))) / V))) / ((pow(Km, GAMMA) + pow((A1 / V), GAMMA)) * (pow(Km, GAMMA) + pow((A1 / V), GAMMA))))) * _A1_nVmax)) +  -((((pow(Km, GAMMA) + pow((A1 / V), GAMMA)) * (pow((A1 / V), GAMMA) * Vmax)) / ((pow(Km, GAMMA) + pow((A1 / V), GAMMA)) * (pow(Km, GAMMA) + pow((A1 / V), GAMMA))))));
}
	//[0,0]  -(tvKa)
	//[1,0] tvKa
	//[3,0] 0.0
	...
	//[0,1] 0.0
	//[1,1]  -(((((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * ((tvVmax * exp(nVmax)) * ((GAMMA * pow((A1 / tvV), (GAMMA - 1.0))) / tvV))) - (((tvVmax * exp(nVmax)) * pow((A1 / tvV), GAMMA)) * ((GAMMA * pow((A1 / tvV), (GAMMA - 1.0))) / tvV))) / ((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * (pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)))))  is not constant
	//[3,1] ((_A1_nVmax *  -((((((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * (pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA))) * (((((tvVmax * exp(nVmax)) * ((GAMMA * pow((A1 / tvV), (GAMMA - 1.0))) / tvV)) * ((GAMMA * pow((A1 / tvV), (GAMMA - 1.0))) / tvV)) + ((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * ((tvVmax * exp(nVmax)) * ((tvV * (GAMMA * (((GAMMA - 1.0) * pow((A1 / tvV), ((GAMMA - 1.0) - 1.0))) / tvV))) / (tvV * tvV))))) - ((((GAMMA * pow((A1 / tvV), (GAMMA - 1.0))) / tvV) * ((tvVmax * exp(nVmax)) * ((GAMMA * pow((A1 / tvV), (GAMMA - 1.0))) / tvV))) + (((tvVmax * exp(nVmax)) * pow((A1 / tvV), GAMMA)) * ((tvV * (GAMMA * (((GAMMA - 1.0) * pow((A1 / tvV), ((GAMMA - 1.0) - 1.0))) / tvV))) / (tvV * tvV)))))) - ((((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * ((tvVmax * exp(nVmax)) * ((GAMMA * pow((A1 / tvV), (GAMMA - 1.0))) / tvV))) - (((tvVmax * exp(nVmax)) * pow((A1 / tvV), GAMMA)) * ((GAMMA * pow((A1 / tvV), (GAMMA - 1.0))) / tvV))) * (((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * ((GAMMA * pow((A1 / tvV), (GAMMA - 1.0))) / tvV)) + ((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * ((GAMMA * pow((A1 / tvV), (GAMMA - 1.0))) / tvV))))) / (((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * (pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA))) * ((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * (pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA))))))) +  -((((((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * (pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA))) * (((pow((A1 / tvV), GAMMA) * (tvVmax * exp(nVmax))) * ((GAMMA * pow((A1 / tvV), (GAMMA - 1.0))) / tvV)) + ((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * ((tvVmax * exp(nVmax)) * ((GAMMA * pow((A1 / tvV), (GAMMA - 1.0))) / tvV))))) - (((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * (pow((A1 / tvV), GAMMA) * (tvVmax * exp(nVmax)))) * (((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * ((GAMMA * pow((A1 / tvV), (GAMMA - 1.0))) / tvV)) + ((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * ((GAMMA * pow((A1 / tvV), (GAMMA - 1.0))) / tvV))))) / (((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * (pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA))) * ((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * (pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)))))))  is not constant

	//[0,3] 0.0
	//[1,3] 0.0
	//[3,3]  -(((((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * ((tvVmax * exp(nVmax)) * ((GAMMA * pow((A1 / tvV), (GAMMA - 1.0))) / tvV))) - (((tvVmax * exp(nVmax)) * pow((A1 / tvV), GAMMA)) * ((GAMMA * pow((A1 / tvV), (GAMMA - 1.0))) / tvV))) / ((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * (pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)))))  is not constant
...
void GradientJacobian(int* pN, double* pt, double zzY[], double zzIRate[], int* pML, int* pMU, double* _gjacobian, int* pNRJ){
	...
	_gjacobian[1 + _nrj*0] = tvKa;
		// w.r.t. A1
	_gjacobian[1 + _nrj*1] =  -(((((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * ((tvVmax * __temp[0]) * ((GAMMA * pow((A1 / tvV), (GAMMA - 1.0))) / tvV))) - (((tvVmax * __temp[0]) * pow((A1 / tvV), GAMMA)) * ((GAMMA * pow((A1 / tvV), (GAMMA - 1.0))) / tvV))) / ((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * (pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)))));
		// forcing rate for A1
	_gjacobian[1 + _nrj*2] = 0.0 + zzIRate[1];
	// rate terms for zzR[2]
	// rate terms for _A1_nVmax
		// w.r.t. A1
	_gjacobian[3 + _nrj*1] = ((_A1_nVmax *  -((((((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * (pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA))) * (((((tvVmax * __temp[0]) * ((GAMMA * pow((A1 / tvV), (GAMMA - 1.0))) / tvV)) * ((GAMMA * pow((A1 / tvV), (GAMMA - 1.0))) / tvV)) + ((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * ((tvVmax * __temp[0]) * ((tvV * (GAMMA * (((GAMMA - 1.0) * pow((A1 / tvV), ((GAMMA - 1.0) - 1.0))) / tvV))) / (tvV * tvV))))) - ((((GAMMA * pow((A1 / tvV), (GAMMA - 1.0))) / tvV) * ((tvVmax * __temp[0]) * ((GAMMA * pow((A1 / tvV), (GAMMA - 1.0))) / tvV))) + (((tvVmax * __temp[0]) * pow((A1 / tvV), GAMMA)) * ((tvV * (GAMMA * (((GAMMA - 1.0) * pow((A1 / tvV), ((GAMMA - 1.0) - 1.0))) / tvV))) / (tvV * tvV)))))) - ((((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * ((tvVmax * __temp[0]) * ((GAMMA * pow((A1 / tvV), (GAMMA - 1.0))) / tvV))) - (((tvVmax * __temp[0]) * pow((A1 / tvV), GAMMA)) * ((GAMMA * pow((A1 / tvV), (GAMMA - 1.0))) / tvV))) * (((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * ((GAMMA * pow((A1 / tvV), (GAMMA - 1.0))) / tvV)) + ((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * ((GAMMA * pow((A1 / tvV), (GAMMA - 1.0))) / tvV))))) / (((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * (pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA))) * ((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * (pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA))))))) +  -((((((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * (pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA))) * (((pow((A1 / tvV), GAMMA) * (tvVmax * __temp[0])) * ((GAMMA * pow((A1 / tvV), (GAMMA - 1.0))) / tvV)) + ((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * ((tvVmax * __temp[0]) * ((GAMMA * pow((A1 / tvV), (GAMMA - 1.0))) / tvV))))) - (((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * (pow((A1 / tvV), GAMMA) * (tvVmax * __temp[0]))) * (((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * ((GAMMA * pow((A1 / tvV), (GAMMA - 1.0))) / tvV)) + ((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * ((GAMMA * pow((A1 / tvV), (GAMMA - 1.0))) / tvV))))) / (((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * (pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA))) * ((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * (pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)))))));
		// w.r.t. _A1_nVmax
	_gjacobian[3 + _nrj*3] =  -(((((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * ((tvVmax * __temp[0]) * ((GAMMA * pow((A1 / tvV), (GAMMA - 1.0))) / tvV))) - (((tvVmax * __temp[0]) * pow((A1 / tvV), GAMMA)) * ((GAMMA * pow((A1 / tvV), (GAMMA - 1.0))) / tvV))) / ((pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)) * (pow(tvKm, GAMMA) + pow((A1 / tvV), GAMMA)))));
}
...
void NewGetLL(int bGenGradients, double _dLL[], double _dLLdEta[], double zzY[], double zzIRate[], int* pnObs, double _t, const char* _nm, double _v1, int bBql)
{
    ...
    if (_nm[0]=='C' && strcmp(_nm, "CObs")==0){
		...
		if (bGenGradients){
			...
			_VecAddTo(1, _dLLdEta1, _dLLdEta);
		}
		_dLL[0] += _dLL1;
	...
	)
{
	...
	int _nObs = 0;
	double _dLLLocal[1];
	double _dGradLocal[1];
	memset(_dGrad, 0, sizeof(double)*1);
	_dLLLocal[0] = 0;
    ...
    if (_nm[0]=='C' && strcmp(_nm, "CObs")==0){
        ...
        if (FALSE && ALLOWLOGTRANSFORM && bEnableLogTransform){
            *_pPred = logfl((C + (_eps * sqrt((1.0 + (pow(C, 2.0) * pow((CMultStdev / sigma()), 2.0)))))));
            _eps = _pcb->GetNormal() * _fixef[6]; // get a N(0,stdev)
