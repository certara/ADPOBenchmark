...
static double _tempResult[2];
static double _tempArg[2];
int _bTempValid = 0;
void InitTemp(){ int _i;
	for (_i = 0; _i < 2; _i++) _tempResult[_i] = -999999999.0;
	for (_i = 0; _i < 2; _i++) _tempArg[_i]    = -999999999.0;
	_bTempValid = 1;
}
void EvalSParms(double* zzY){
	...
	V = (tvV * _exp_cached(nV, &_tempArg[1], &_tempResult[1]));
...
void Deriv(long* _pN, double* _pt, double zzY[], double zzR[], double zzIRate[]){
	...
	// 0.0
	// 0.0
	// ( -(K12) - ((((tvKm + (A1 / (tvV * exp(nV)))) * ((tvVmax * exp(nVmax)) / (tvV * exp(nV)))) - (((tvVmax * exp(nVmax)) * (A1 / (tvV * exp(nV)))) / (tvV * exp(nV)))) / ((tvKm + (A1 / (tvV * exp(nV)))) * (tvKm + (A1 / (tvV * exp(nV)))))))  is not constant
	// K12
	// 0.0
	// K21
	//  -(K21)
...
void Jacobian(int* pN, double* pt, double zzY[], double zzIRate[], int* pML, int* pMU, double* _jacobian, int* pNRJ){
	...
	_jacobian[1 + _nrj*0] = tvKa;
		// w.r.t. A1
	_jacobian[1 + _nrj*1] = ( -(K12) - ((((tvKm + (A1 / (tvV * __temp[0]))) * ((tvVmax * __temp[1]) / (tvV * __temp[0]))) - (((tvVmax * __temp[1]) * (A1 / (tvV * __temp[0]))) / (tvV * __temp[0]))) / ((tvKm + (A1 / (tvV * __temp[0]))) * (tvKm + (A1 / (tvV * __temp[0]))))));
		// w.r.t. A2
...
void GradientDeriv(long* _pN, double* _pt, double zzY[], double zzR[], double zzIRate[])
{
	...
	//[0,1] 0.0
	//[1,1] ( -(K12) - ((((tvKm + (A1 / (tvV * exp(nV)))) * ((tvVmax * exp(nVmax)) / (tvV * exp(nV)))) - (((tvVmax * exp(nVmax)) * (A1 / (tvV * exp(nV)))) / (tvV * exp(nV)))) / ((tvKm + (A1 / (tvV * exp(nV)))) * (tvKm + (A1 / (tvV * exp(nV)))))))  is not constant
	//[2,1] K12
	//[4,1] ((_A1_nVmax *  -((((((tvKm + (A1 / (tvV * exp(nV)))) * (tvKm + (A1 / (tvV * exp(nV))))) * ((((tvVmax * exp(nVmax)) / (tvV * exp(nV))) / (tvV * exp(nV))) - (((tvV * exp(nV)) * ((tvVmax * exp(nVmax)) / (tvV * exp(nV)))) / ((tvV * exp(nV)) * (tvV * exp(nV)))))) - ((((tvKm + (A1 / (tvV * exp(nV)))) * ((tvVmax * exp(nVmax)) / (tvV * exp(nV)))) - (((tvVmax * exp(nVmax)) * (A1 / (tvV * exp(nV)))) / (tvV * exp(nV)))) * (((tvKm + (A1 / (tvV * exp(nV)))) / (tvV * exp(nV))) + ((tvKm + (A1 / (tvV * exp(nV)))) / (tvV * exp(nV)))))) / (((tvKm + (A1 / (tvV * exp(nV)))) * (tvKm + (A1 / (tvV * exp(nV))))) * ((tvKm + (A1 / (tvV * exp(nV)))) * (tvKm + (A1 / (tvV * exp(nV))))))))) +  -((((((tvKm + (A1 / (tvV * exp(nV)))) * (tvKm + (A1 / (tvV * exp(nV))))) * ((((A1 / (tvV * exp(nV))) * (tvVmax * exp(nVmax))) / (tvV * exp(nV))) + ((tvKm + (A1 / (tvV * exp(nV)))) * ((tvVmax * exp(nVmax)) / (tvV * exp(nV)))))) - (((tvKm + (A1 / (tvV * exp(nV)))) * ((A1 / (tvV * exp(nV))) * (tvVmax * exp(nVmax)))) * (((tvKm + (A1 / (tvV * exp(nV)))) / (tvV * exp(nV))) + ((tvKm + (A1 / (tvV * exp(nV)))) / (tvV * exp(nV)))))) / (((tvKm + (A1 / (tvV * exp(nV)))) * (tvKm + (A1 / (tvV * exp(nV))))) * ((tvKm + (A1 / (tvV * exp(nV)))) * (tvKm + (A1 / (tvV * exp(nV)))))))))  is not constant
	//[5,1] 0.0
	//[6,1] ((_A1_nV *  -((((((tvKm + (A1 / (tvV * exp(nV)))) * (tvKm + (A1 / (tvV * exp(nV))))) * ((((tvVmax * exp(nVmax)) / (tvV * exp(nV))) / (tvV * exp(nV))) - (((tvV * exp(nV)) * ((tvVmax * exp(nVmax)) / (tvV * exp(nV)))) / ((tvV * exp(nV)) * (tvV * exp(nV)))))) - ((((tvKm + (A1 / (tvV * exp(nV)))) * ((tvVmax * exp(nVmax)) / (tvV * exp(nV)))) - (((tvVmax * exp(nVmax)) * (A1 / (tvV * exp(nV)))) / (tvV * exp(nV)))) * (((tvKm + (A1 / (tvV * exp(nV)))) / (tvV * exp(nV))) + ((tvKm + (A1 / (tvV * exp(nV)))) / (tvV * exp(nV)))))) / (((tvKm + (A1 / (tvV * exp(nV)))) * (tvKm + (A1 / (tvV * exp(nV))))) * ((tvKm + (A1 / (tvV * exp(nV)))) * (tvKm + (A1 / (tvV * exp(nV))))))))) +  -((((((tvKm + (A1 / (tvV * exp(nV)))) * (tvKm + (A1 / (tvV * exp(nV))))) * (((((tvVmax * exp(nVmax)) * ( -((A1 * (tvV * exp(nV)))) / ((tvV * exp(nV)) * (tvV * exp(nV))))) / (tvV * exp(nV))) + ((tvKm + (A1 / (tvV * exp(nV)))) * ((tvVmax * exp(nVmax)) * ((((tvV * exp(nV)) * (tvV * exp(nV))) *  -((tvV * exp(nV)))) / (((tvV * exp(nV)) * (tvV * exp(nV))) * ((tvV * exp(nV)) * (tvV * exp(nV)))))))) - ((( -((A1 * (tvV * exp(nV)))) / ((tvV * exp(nV)) * (tvV * exp(nV)))) * ((tvVmax * exp(nVmax)) / (tvV * exp(nV)))) + (((tvVmax * exp(nVmax)) * (A1 / (tvV * exp(nV)))) * ((((tvV * exp(nV)) * (tvV * exp(nV))) *  -((tvV * exp(nV)))) / (((tvV * exp(nV)) * (tvV * exp(nV))) * ((tvV * exp(nV)) * (tvV * exp(nV))))))))) - ((((tvKm + (A1 / (tvV * exp(nV)))) * ((tvVmax * exp(nVmax)) * ( -((A1 * (tvV * exp(nV)))) / ((tvV * exp(nV)) * (tvV * exp(nV)))))) - (((tvVmax * exp(nVmax)) * (A1 / (tvV * exp(nV)))) * ( -((A1 * (tvV * exp(nV)))) / ((tvV * exp(nV)) * (tvV * exp(nV)))))) * (((tvKm + (A1 / (tvV * exp(nV)))) / (tvV * exp(nV))) + ((tvKm + (A1 / (tvV * exp(nV)))) / (tvV * exp(nV)))))) / (((tvKm + (A1 / (tvV * exp(nV)))) * (tvKm + (A1 / (tvV * exp(nV))))) * ((tvKm + (A1 / (tvV * exp(nV)))) * (tvKm + (A1 / (tvV * exp(nV)))))))))  is not constant
	//[7,1] 0.0
	...
	//[1,4] 0.0
	//[2,4] 0.0
	//[4,4] ( -(K12) - ((((tvKm + (A1 / (tvV * exp(nV)))) * ((tvVmax * exp(nVmax)) / (tvV * exp(nV)))) - (((tvVmax * exp(nVmax)) * (A1 / (tvV * exp(nV)))) / (tvV * exp(nV)))) / ((tvKm + (A1 / (tvV * exp(nV)))) * (tvKm + (A1 / (tvV * exp(nV)))))))  is not constant
	//[5,4] K12
	//[6,4] 0.0
	//[7,4] 0.0
	...
	//[4,6] 0.0
	//[5,6] 0.0
	//[6,6] ( -(K12) - ((((tvKm + (A1 / (tvV * exp(nV)))) * ((tvVmax * exp(nVmax)) / (tvV * exp(nV)))) - (((tvVmax * exp(nVmax)) * (A1 / (tvV * exp(nV)))) / (tvV * exp(nV)))) / ((tvKm + (A1 / (tvV * exp(nV)))) * (tvKm + (A1 / (tvV * exp(nV)))))))  is not constant
	//[7,6] K12
...
void GradientJacobian(int* pN, double* pt, double zzY[], double zzIRate[], int* pML, int* pMU, double* _gjacobian, int* pNRJ){
	...
	_gjacobian[1 + _nrj*0] = tvKa;
		// w.r.t. A1
	_gjacobian[1 + _nrj*1] = ( -(K12) - ((((tvKm + (A1 / (tvV * __temp[0]))) * ((tvVmax * __temp[1]) / (tvV * __temp[0]))) - (((tvVmax * __temp[1]) * (A1 / (tvV * __temp[0]))) / (tvV * __temp[0]))) / ((tvKm + (A1 / (tvV * __temp[0]))) * (tvKm + (A1 / (tvV * __temp[0]))))));
		// w.r.t. A2
	...
	// rate terms for _A1_nVmax
		// w.r.t. A1
	_gjacobian[4 + _nrj*1] = ((_A1_nVmax *  -((((((tvKm + (A1 / (tvV * __temp[0]))) * (tvKm + (A1 / (tvV * __temp[0])))) * ((((tvVmax * __temp[1]) / (tvV * __temp[0])) / (tvV * __temp[0])) - (((tvV * __temp[0]) * ((tvVmax * __temp[1]) / (tvV * __temp[0]))) / ((tvV * __temp[0]) * (tvV * __temp[0]))))) - ((((tvKm + (A1 / (tvV * __temp[0]))) * ((tvVmax * __temp[1]) / (tvV * __temp[0]))) - (((tvVmax * __temp[1]) * (A1 / (tvV * __temp[0]))) / (tvV * __temp[0]))) * (((tvKm + (A1 / (tvV * __temp[0]))) / (tvV * __temp[0])) + ((tvKm + (A1 / (tvV * __temp[0]))) / (tvV * __temp[0]))))) / (((tvKm + (A1 / (tvV * __temp[0]))) * (tvKm + (A1 / (tvV * __temp[0])))) * ((tvKm + (A1 / (tvV * __temp[0]))) * (tvKm + (A1 / (tvV * __temp[0])))))))) +  -((((((tvKm + (A1 / (tvV * __temp[0]))) * (tvKm + (A1 / (tvV * __temp[0])))) * ((((A1 / (tvV * __temp[0])) * (tvVmax * __temp[1])) / (tvV * __temp[0])) + ((tvKm + (A1 / (tvV * __temp[0]))) * ((tvVmax * __temp[1]) / (tvV * __temp[0]))))) - (((tvKm + (A1 / (tvV * __temp[0]))) * ((A1 / (tvV * __temp[0])) * (tvVmax * __temp[1]))) * (((tvKm + (A1 / (tvV * __temp[0]))) / (tvV * __temp[0])) + ((tvKm + (A1 / (tvV * __temp[0]))) / (tvV * __temp[0]))))) / (((tvKm + (A1 / (tvV * __temp[0]))) * (tvKm + (A1 / (tvV * __temp[0])))) * ((tvKm + (A1 / (tvV * __temp[0]))) * (tvKm + (A1 / (tvV * __temp[0]))))))));
		// w.r.t. _A1_nVmax
	_gjacobian[4 + _nrj*4] = ( -(K12) - ((((tvKm + (A1 / (tvV * __temp[0]))) * ((tvVmax * __temp[1]) / (tvV * __temp[0]))) - (((tvVmax * __temp[1]) * (A1 / (tvV * __temp[0]))) / (tvV * __temp[0]))) / ((tvKm + (A1 / (tvV * __temp[0]))) * (tvKm + (A1 / (tvV * __temp[0]))))));
		// w.r.t. _A2_nVmax
	...
	// rate terms for _A1_nV
		// w.r.t. A1
	_gjacobian[6 + _nrj*1] = ((_A1_nV *  -((((((tvKm + (A1 / (tvV * __temp[0]))) * (tvKm + (A1 / (tvV * __temp[0])))) * ((((tvVmax * __temp[1]) / (tvV * __temp[0])) / (tvV * __temp[0])) - (((tvV * __temp[0]) * ((tvVmax * __temp[1]) / (tvV * __temp[0]))) / ((tvV * __temp[0]) * (tvV * __temp[0]))))) - ((((tvKm + (A1 / (tvV * __temp[0]))) * ((tvVmax * __temp[1]) / (tvV * __temp[0]))) - (((tvVmax * __temp[1]) * (A1 / (tvV * __temp[0]))) / (tvV * __temp[0]))) * (((tvKm + (A1 / (tvV * __temp[0]))) / (tvV * __temp[0])) + ((tvKm + (A1 / (tvV * __temp[0]))) / (tvV * __temp[0]))))) / (((tvKm + (A1 / (tvV * __temp[0]))) * (tvKm + (A1 / (tvV * __temp[0])))) * ((tvKm + (A1 / (tvV * __temp[0]))) * (tvKm + (A1 / (tvV * __temp[0])))))))) +  -((((((tvKm + (A1 / (tvV * __temp[0]))) * (tvKm + (A1 / (tvV * __temp[0])))) * (((((tvVmax * __temp[1]) * ( -((A1 * (tvV * __temp[0]))) / ((tvV * __temp[0]) * (tvV * __temp[0])))) / (tvV * __temp[0])) + ((tvKm + (A1 / (tvV * __temp[0]))) * ((tvVmax * __temp[1]) * ((((tvV * __temp[0]) * (tvV * __temp[0])) *  -((tvV * __temp[0]))) / (((tvV * __temp[0]) * (tvV * __temp[0])) * ((tvV * __temp[0]) * (tvV * __temp[0]))))))) - ((( -((A1 * (tvV * __temp[0]))) / ((tvV * __temp[0]) * (tvV * __temp[0]))) * ((tvVmax * __temp[1]) / (tvV * __temp[0]))) + (((tvVmax * __temp[1]) * (A1 / (tvV * __temp[0]))) * ((((tvV * __temp[0]) * (tvV * __temp[0])) *  -((tvV * __temp[0]))) / (((tvV * __temp[0]) * (tvV * __temp[0])) * ((tvV * __temp[0]) * (tvV * __temp[0])))))))) - ((((tvKm + (A1 / (tvV * __temp[0]))) * ((tvVmax * __temp[1]) * ( -((A1 * (tvV * __temp[0]))) / ((tvV * __temp[0]) * (tvV * __temp[0]))))) - (((tvVmax * __temp[1]) * (A1 / (tvV * __temp[0]))) * ( -((A1 * (tvV * __temp[0]))) / ((tvV * __temp[0]) * (tvV * __temp[0]))))) * (((tvKm + (A1 / (tvV * __temp[0]))) / (tvV * __temp[0])) + ((tvKm + (A1 / (tvV * __temp[0]))) / (tvV * __temp[0]))))) / (((tvKm + (A1 / (tvV * __temp[0]))) * (tvKm + (A1 / (tvV * __temp[0])))) * ((tvKm + (A1 / (tvV * __temp[0]))) * (tvKm + (A1 / (tvV * __temp[0]))))))));
		// w.r.t. _A1_nV
	_gjacobian[6 + _nrj*6] = ( -(K12) - ((((tvKm + (A1 / (tvV * __temp[0]))) * ((tvVmax * __temp[1]) / (tvV * __temp[0]))) - (((tvVmax * __temp[1]) * (A1 / (tvV * __temp[0]))) / (tvV * __temp[0]))) / ((tvKm + (A1 / (tvV * __temp[0]))) * (tvKm + (A1 / (tvV * __temp[0]))))));
		// w.r.t. _A2_nV
