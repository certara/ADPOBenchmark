 ...
 num_processes <- 4
 localWorkingDir <- "C:/git/adpoBenchmark/NLME/10/fitmodel_run10_02"
 SharedWorkingDir <- "C:/git/adpoBenchmark/NLME/10/fitmodel_run10_02/GEN241004133305.31/Shared"
 ...
 control_lines <- c('WorkFlow,jobArgsCombined.txt:1,*,out.txt,err1.txt err2.txt ps1err.txt fort.27 integration_errors.txt nlme7engine.log out.txt dmp.txt,  ')
