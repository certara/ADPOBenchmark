...
int GetNThetaOld(){	// get number of theta minus possibly 1 sigma to estimate
	int _n = 7 + 1; // number of fixefs + number of epsilons
...
void GetSaemThetaInfo(int* iaCColToITheta, int* baCColIsLog){
	int _jCTheta = 0;
	int _nTheta = 0;
	int _iaIFixefErrToITheta[7+1];
	int _i;
	for (_i = 0; _i < 7+1; _i++) _iaIFixefErrToITheta[_i] = -1;
...
#define     _Aa_nKa       zzY1[6]
#define zzR__Aa_nKa       zzR1[6]

#define     _A1_nKa       zzY1[7]
#define zzR__A1_nKa       zzR1[7]

#define     _A2_nKa       zzY1[8]
#define zzR__A2_nKa       zzR1[8]

#define NINTEG_GRADIENT_DERIV 9
...
void GradientDeriv(long* _pN, double* _pt, double zzY[], double zzR[], double zzIRate[])
{
	...
	zzR__A1_nKm = ((((Ka * _Aa_nKm) + (( -(K12) - ((((Km + (A1 / V)) * (Vmax / V)) - ((Vmax * (A1 / V)) / V)) / ((Km + (A1 / V)) * (Km + (A1 / V))))) * _A1_nKm)) + (K21 * _A2_nKm)) +  -(((((Km + (A1 / V)) * (Vmax * ( -((A1 * V)) / (V * V)))) - ((Vmax * (A1 / V)) * ( -((A1 * V)) / (V * V)))) / ((Km + (A1 / V)) * (Km + (A1 / V))))));
	zzR__A2_nKm = ((K12 * _A1_nKm) + ( -(K21) * _A2_nKm));
	zzR__A1_nV = ((((Ka * _Aa_nV) + (( -(K12) - ((((Km + (A1 / V)) * (Vmax / V)) - ((Vmax * (A1 / V)) / V)) / ((Km + (A1 / V)) * (Km + (A1 / V))))) * _A1_nV)) + (K21 * _A2_nV)) +  -(( -(((Vmax * (A1 / V)) * Km)) / ((Km + (A1 / V)) * (Km + (A1 / V))))));
	zzR__A2_nV = ((K12 * _A1_nV) + ( -(K21) * _A2_nV));
	zzR__Aa_nKa = (( -(Ka) * _Aa_nKa) + (Aa *  -(Ka)));
	zzR__A1_nKa = ((((Ka * _Aa_nKa) + (( -(K12) - ((((Km + (A1 / V)) * (Vmax / V)) - ((Vmax * (A1 / V)) / V)) / ((Km + (A1 / V)) * (Km + (A1 / V))))) * _A1_nKa)) + (K21 * _A2_nKa)) + (Aa * Ka));
	...
	//[5,1] 0.0
	//[6,1] ((_A1_nKm *  -(((((((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) * ((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm))))) * ((((tvVmax * exp(nVmax)) / (tvV * exp(nKm))) / (tvV * exp(nKm))) - (((tvV * exp(nKm)) * ((tvVmax * exp(nVmax)) / (tvV * exp(nKm)))) / ((tvV * exp(nKm)) * (tvV * exp(nKm)))))) - (((((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) * ((tvVmax * exp(nVmax)) / (tvV * exp(nKm)))) - (((tvVmax * exp(nVmax)) * (A1 / (tvV * exp(nKm)))) / (tvV * exp(nKm)))) * ((((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) / (tvV * exp(nKm))) + (((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) / (tvV * exp(nKm)))))) / ((((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) * ((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm))))) * (((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) * ((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm))))))))) +  -(((((((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) * ((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm))))) * (((((tvVmax * exp(nVmax)) * ( -((A1 * (tvV * exp(nKm)))) / ((tvV * exp(nKm)) * (tvV * exp(nKm))))) / (tvV * exp(nKm))) + (((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) * ((tvVmax * exp(nVmax)) * ((((tvV * exp(nKm)) * (tvV * exp(nKm))) *  -((tvV * exp(nKm)))) / (((tvV * exp(nKm)) * (tvV * exp(nKm))) * ((tvV * exp(nKm)) * (tvV * exp(nKm)))))))) - ((( -((A1 * (tvV * exp(nKm)))) / ((tvV * exp(nKm)) * (tvV * exp(nKm)))) * ((tvVmax * exp(nVmax)) / (tvV * exp(nKm)))) + (((tvVmax * exp(nVmax)) * (A1 / (tvV * exp(nKm)))) * ((((tvV * exp(nKm)) * (tvV * exp(nKm))) *  -((tvV * exp(nKm)))) / (((tvV * exp(nKm)) * (tvV * exp(nKm))) * ((tvV * exp(nKm)) * (tvV * exp(nKm))))))))) - (((((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) * ((tvVmax * exp(nVmax)) * ( -((A1 * (tvV * exp(nKm)))) / ((tvV * exp(nKm)) * (tvV * exp(nKm)))))) - (((tvVmax * exp(nVmax)) * (A1 / (tvV * exp(nKm)))) * ( -((A1 * (tvV * exp(nKm)))) / ((tvV * exp(nKm)) * (tvV * exp(nKm)))))) * ((((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) / (tvV * exp(nKm))) + (((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) / (tvV * exp(nKm)))))) / ((((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) * ((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm))))) * (((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) * ((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))))))))  is not constant
	//[7,1] 0.0
	//[8,1] ((_A1_nV *  -(((((((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) * ((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm))))) * ((((tvVmax * exp(nVmax)) / (tvV * exp(nKm))) / (tvV * exp(nKm))) - (((tvV * exp(nKm)) * ((tvVmax * exp(nVmax)) / (tvV * exp(nKm)))) / ((tvV * exp(nKm)) * (tvV * exp(nKm)))))) - (((((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) * ((tvVmax * exp(nVmax)) / (tvV * exp(nKm)))) - (((tvVmax * exp(nVmax)) * (A1 / (tvV * exp(nKm)))) / (tvV * exp(nKm)))) * ((((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) / (tvV * exp(nKm))) + (((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) / (tvV * exp(nKm)))))) / ((((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) * ((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm))))) * (((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) * ((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm))))))))) +  -(((((((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) * ((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm))))) *  -(((tvKm * exp(nV)) * ((tvVmax * exp(nVmax)) / (tvV * exp(nKm)))))) - ( -((((tvVmax * exp(nVmax)) * (A1 / (tvV * exp(nKm)))) * (tvKm * exp(nV)))) * ((((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) / (tvV * exp(nKm))) + (((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) / (tvV * exp(nKm)))))) / ((((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) * ((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm))))) * (((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) * ((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))))))))  is not constant
	//[9,1] 0.0
	//[10,1] 0.0
	//[11,1] (_A1_nKa *  -(((((((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) * ((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm))))) * ((((tvVmax * exp(nVmax)) / (tvV * exp(nKm))) / (tvV * exp(nKm))) - (((tvV * exp(nKm)) * ((tvVmax * exp(nVmax)) / (tvV * exp(nKm)))) / ((tvV * exp(nKm)) * (tvV * exp(nKm)))))) - (((((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) * ((tvVmax * exp(nVmax)) / (tvV * exp(nKm)))) - (((tvVmax * exp(nVmax)) * (A1 / (tvV * exp(nKm)))) / (tvV * exp(nKm)))) * ((((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) / (tvV * exp(nKm))) + (((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) / (tvV * exp(nKm)))))) / ((((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) * ((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm))))) * (((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) * ((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))))))))  is not constant
	//[12,1] 0.0
	...
	//[1,4] 0.0
	//[2,4] 0.0
	//[4,4] ( -(K12) - (((((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) * ((tvVmax * exp(nVmax)) / (tvV * exp(nKm)))) - (((tvVmax * exp(nVmax)) * (A1 / (tvV * exp(nKm)))) / (tvV * exp(nKm)))) / (((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) * ((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))))))  is not constant
	//[5,4] K12
	//[6,4] 0.0
	//[7,4] 0.0
	//[8,4] 0.0
	...
	//[4,6] 0.0
	//[5,6] 0.0
	//[6,6] ( -(K12) - (((((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) * ((tvVmax * exp(nVmax)) / (tvV * exp(nKm)))) - (((tvVmax * exp(nVmax)) * (A1 / (tvV * exp(nKm)))) / (tvV * exp(nKm)))) / (((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))) * ((tvKm * exp(nV)) + (A1 / (tvV * exp(nKm)))))))  is not constant
	//[7,6] K12
	//[8,6] 0.0
	//[9,6] 0.0
	//[10,6] 0.0
...
void GradientJacobian(int* pN, double* pt, double zzY[], double zzIRate[], int* pML, int* pMU, double* _gjacobian, int* pNRJ){
	...
	_gjacobian[4 + _nrj*1] = ((_A1_nVmax *  -(((((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2])))) * ((((tvVmax * __temp[3]) / (tvV * __temp[2])) / (tvV * __temp[2])) - (((tvV * __temp[2]) * ((tvVmax * __temp[3]) / (tvV * __temp[2]))) / ((tvV * __temp[2]) * (tvV * __temp[2]))))) - (((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvVmax * __temp[3]) / (tvV * __temp[2]))) - (((tvVmax * __temp[3]) * (A1 / (tvV * __temp[2]))) / (tvV * __temp[2]))) * ((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) / (tvV * __temp[2])) + (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) / (tvV * __temp[2]))))) / ((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2])))) * (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2])))))))) +  -(((((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2])))) * ((((A1 / (tvV * __temp[2])) * (tvVmax * __temp[3])) / (tvV * __temp[2])) + (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvVmax * __temp[3]) / (tvV * __temp[2]))))) - ((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((A1 / (tvV * __temp[2])) * (tvVmax * __temp[3]))) * ((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) / (tvV * __temp[2])) + (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) / (tvV * __temp[2]))))) / ((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2])))) * (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))))))));
		// w.r.t. _A1_nVmax
	_gjacobian[4 + _nrj*4] = ( -(K12) - (((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvVmax * __temp[3]) / (tvV * __temp[2]))) - (((tvVmax * __temp[3]) * (A1 / (tvV * __temp[2]))) / (tvV * __temp[2]))) / (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))))));
		// w.r.t. _A2_nVmax
	...
	// rate terms for _A1_nKm
		// w.r.t. A1
	_gjacobian[6 + _nrj*1] = ((_A1_nKm *  -(((((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2])))) * ((((tvVmax * __temp[3]) / (tvV * __temp[2])) / (tvV * __temp[2])) - (((tvV * __temp[2]) * ((tvVmax * __temp[3]) / (tvV * __temp[2]))) / ((tvV * __temp[2]) * (tvV * __temp[2]))))) - (((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvVmax * __temp[3]) / (tvV * __temp[2]))) - (((tvVmax * __temp[3]) * (A1 / (tvV * __temp[2]))) / (tvV * __temp[2]))) * ((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) / (tvV * __temp[2])) + (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) / (tvV * __temp[2]))))) / ((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2])))) * (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2])))))))) +  -(((((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2])))) * (((((tvVmax * __temp[3]) * ( -((A1 * (tvV * __temp[2]))) / ((tvV * __temp[2]) * (tvV * __temp[2])))) / (tvV * __temp[2])) + (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvVmax * __temp[3]) * ((((tvV * __temp[2]) * (tvV * __temp[2])) *  -((tvV * __temp[2]))) / (((tvV * __temp[2]) * (tvV * __temp[2])) * ((tvV * __temp[2]) * (tvV * __temp[2]))))))) - ((( -((A1 * (tvV * __temp[2]))) / ((tvV * __temp[2]) * (tvV * __temp[2]))) * ((tvVmax * __temp[3]) / (tvV * __temp[2]))) + (((tvVmax * __temp[3]) * (A1 / (tvV * __temp[2]))) * ((((tvV * __temp[2]) * (tvV * __temp[2])) *  -((tvV * __temp[2]))) / (((tvV * __temp[2]) * (tvV * __temp[2])) * ((tvV * __temp[2]) * (tvV * __temp[2])))))))) - (((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvVmax * __temp[3]) * ( -((A1 * (tvV * __temp[2]))) / ((tvV * __temp[2]) * (tvV * __temp[2]))))) - (((tvVmax * __temp[3]) * (A1 / (tvV * __temp[2]))) * ( -((A1 * (tvV * __temp[2]))) / ((tvV * __temp[2]) * (tvV * __temp[2]))))) * ((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) / (tvV * __temp[2])) + (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) / (tvV * __temp[2]))))) / ((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2])))) * (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))))))));
		// w.r.t. _A1_nKm
	_gjacobian[6 + _nrj*6] = ( -(K12) - (((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvVmax * __temp[3]) / (tvV * __temp[2]))) - (((tvVmax * __temp[3]) * (A1 / (tvV * __temp[2]))) / (tvV * __temp[2]))) / (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))))));
		// w.r.t. _A2_nKm
	...
	// rate terms for _A1_nV
		// w.r.t. A1
	_gjacobian[8 + _nrj*1] = ((_A1_nV *  -(((((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2])))) * ((((tvVmax * __temp[3]) / (tvV * __temp[2])) / (tvV * __temp[2])) - (((tvV * __temp[2]) * ((tvVmax * __temp[3]) / (tvV * __temp[2]))) / ((tvV * __temp[2]) * (tvV * __temp[2]))))) - (((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvVmax * __temp[3]) / (tvV * __temp[2]))) - (((tvVmax * __temp[3]) * (A1 / (tvV * __temp[2]))) / (tvV * __temp[2]))) * ((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) / (tvV * __temp[2])) + (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) / (tvV * __temp[2]))))) / ((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2])))) * (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2])))))))) +  -(((((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2])))) *  -(((tvKm * __temp[1]) * ((tvVmax * __temp[3]) / (tvV * __temp[2]))))) - ( -((((tvVmax * __temp[3]) * (A1 / (tvV * __temp[2]))) * (tvKm * __temp[1]))) * ((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) / (tvV * __temp[2])) + (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) / (tvV * __temp[2]))))) / ((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2])))) * (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))))))));
		// w.r.t. _A1_nV
	...
	// rate terms for _Aa_nKa
		// w.r.t. Aa
	_gjacobian[10 + _nrj*0] =  -((tvKa * __temp[0]));
		// w.r.t. _Aa_nKa
	_gjacobian[10 + _nrj*10] =  -((tvKa * __temp[0]));
	// rate terms for _A1_nKa
		// w.r.t. Aa
	_gjacobian[11 + _nrj*0] = (tvKa * __temp[0]);
		// w.r.t. A1
	_gjacobian[11 + _nrj*1] = (_A1_nKa *  -(((((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2])))) * ((((tvVmax * __temp[3]) / (tvV * __temp[2])) / (tvV * __temp[2])) - (((tvV * __temp[2]) * ((tvVmax * __temp[3]) / (tvV * __temp[2]))) / ((tvV * __temp[2]) * (tvV * __temp[2]))))) - (((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvVmax * __temp[3]) / (tvV * __temp[2]))) - (((tvVmax * __temp[3]) * (A1 / (tvV * __temp[2]))) / (tvV * __temp[2]))) * ((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) / (tvV * __temp[2])) + (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) / (tvV * __temp[2]))))) / ((((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2])))) * (((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))) * ((tvKm * __temp[1]) + (A1 / (tvV * __temp[2]))))))));
		// w.r.t. _Aa_nKa
	_gjacobian[11 + _nrj*10] = (tvKa * __temp[0]);
		// w.r.t. _A1_nKa
    ...
    if (_nm[0]=='C' && strcmp(_nm, "CObs")==0){
        ...
        if (FALSE && ALLOWLOGTRANSFORM && bEnableLogTransform){
            *_pPred = logfl((C + (_eps * sqrt((1.0 + (pow(C, 2.0) * pow((CMultStdev / sigma()), 2.0)))))));
            _eps = _pcb->GetNormal() * _fixef[7]; // get a N(0,stdev)
